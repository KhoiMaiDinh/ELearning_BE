...
@QueueEventsListener(QueueName.PROGRESS, { blockingTimeout: 300000 })
export class ProgressQueueEvents extends QueueEventsHost {
  private readonly logger = new Logger(ProgressQueueEvents.name);
